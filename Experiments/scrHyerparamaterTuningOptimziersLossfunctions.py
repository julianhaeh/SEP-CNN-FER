...
# Load Datasets
trainDataLoader = DataLoader(OurDatasetTuning(section='training',split='train'), batch_size=BATCH_SIZE, shuffle=True)
...
def train_evaluate_pipeline(model, criterion, optimizer, scheduler, epochs=50):
    ...
    for epoch in range(epochs):
        ...
        print(f"Epoch {epoch+1} - Train Loss: {running_loss / len(trainDataLoader):.4f}")

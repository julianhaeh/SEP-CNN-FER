...
# --- DEBUG CONSTANTS ---
SAVE_MODELS = False
LOG_FILE = "Experiments/Plots/GAP_CNN_training_history.txt"
...
MODEL_CONFIGS = {
    ...
    "GAP_3Blocks_32-48-64": {
        ...
        "classifier_config" : fixed_classifier

    },

    "GAP_3Blocks_48-64-96": {
        "feature_config" : [
                                # --- Block 1 ---
                                {'type': 'conv', 'out': 48, 'k': 3, 's': 1, 'p': 1},
                                {'type': 'norm'}, 
...
MODELS_TO_TRAIN = [
    #("GAP_3Blocks_32-48-64", MODEL_CONFIGS["GAP_3Blocks_32-48-64"]),
    #("GAP_3Blocks_48-64-96", MODEL_CONFIGS["GAP_3Blocks_48-64-96"]),
    #("GAP_3Blocks_64-96-128", MODEL_CONFIGS["GAP_3Blocks_64-96-128"]),
    #("GAP_4Blocks_32-48-64-96", MODEL_CONFIGS["GAP_4Blocks_32-48-64-96"]),
    #("GAP_4Blocks_48-64-96-128", MODEL_CONFIGS["GAP_4Blocks_48-64-96-128"]),
    ("GAP_4Blocks_64-96-128-196", MODEL_CONFIGS["GAP_4Blocks_64-96-128-196"]),
]
# --- HELPER FUNCTIONS ---
...
def train_evaluate_pipeline(model_config, config_name="", seed=42):
    ...
    optimizer = optim.SGD(model.parameters(), lr=0.012, momentum=0.9, weight_decay=0.00125)
...
def run_experiments():
    print("Starting GAP CNN Experiments...")

...
from Demo.video_utils import largest_face_bbox, overlay_heatmap, draw_label
...
def _construct_mobilefacenet(num_classes, in_channels, device):
    ...
    if not candidates:
        for name, obj in vars(clsMobileFaceNet).items():
